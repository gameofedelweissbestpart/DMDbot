    ...
    if not grouped_data:
        ...
        for target_id, leaves in grouped_data.items():
            ...
            for leaf in leaves:
                ...
                desc += f"\u17b5 \u17b5 \u17b5 \u17b5 \u17b5 \u17b5 `[{leaf.get('leave_category','ทั่วไป')}]` วันที่: {dr} `(รวม {leaf.get('total_days', 1)} วัน)`\n"
                ...
                desc += f"\u17b5 \u17b5 \u17b5 \u17b5 \u17b5 \u17b5 \u17b5 \u17b5 \u17b5 └ **เหตุผล:** {leaf.get('reason', '-')}{on_behalf_txt}\n"
            desc += "\n"
